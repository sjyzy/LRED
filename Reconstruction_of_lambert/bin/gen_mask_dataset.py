...
if __name__ == '__main__':
    ...
    aparser.add_argument('config', type=str, help='Path to config for dataset generation', default='configs/data_gen/random_thin_512.yaml')
    aparser.add_argument('indir', type=str, help='Path to folder with images',default='/nas_data/ARIS_Public/dataset/DepthEstimation/C3VD/lama_train/C3VD_ori/visual_test_source')
    aparser.add_argument('outdir', type=str, help='Path to folder to store aligned images and masks to',default='/nas_data/ARIS_Public/dataset/DepthEstimation/C3VD/lama_train/C3VD_ori/visual_test/random_thin_512')
